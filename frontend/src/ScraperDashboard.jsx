                    ...
                    <div className="lg:col-span-2 space-y-5">
                        <div className="bg-slate-900/60 border border-slate-800 rounded-lg p-5">
                            ...
                            <input
                                ...
                                className="mt-2 w-full rounded-md bg-slate-950 border border-slate-800 px-3 py-2 text-sm text-slate-200 placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-lime-400/50 focus:border-lime-400/50"
                            />
                            ...
                            <input
                                ...
                                min={1}
                                max={200}
                                className="mt-2 w-32 rounded-md bg-slate-950 border border-slate-800 px-3 py-2 text-sm text-slate-200 focus:outline-none focus:ring-1 focus:ring-lime-400/50 focus:border-lime-400/50"
                            />
                    ...
                    <div className="lg:col-span-3">
                        ...
                        {results.length > 0 && (
                            <div className="mt-6 bg-slate-900/60 border border-slate-800 rounded-lg overflow-hidden">
                                <div className="px-4 py-2 border-b border-slate-800 text-xs font-mono text-slate-500">
                                            ...
                                            {results.map((row, i) => (
                                                <tr key={i} className="border-t border-slate-800/60 hover:bg-slate-800/30">
                                                    {columns.map((col) => (
                                                        <td
                                                            key={col}
                                                            className="px-4 py-2 text-slate-300 max-w-xs truncate"
