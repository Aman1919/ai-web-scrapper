...
import { JobCleanStatus, JobCounts, JobStatus, MetricsType, QueueAdapterOptions, QueueDefaultJobOptions, QueueJobOptions, QueueMetrics, Status } from '../../typings/app';
...
export declare class BullMQAdapter extends BaseAdapter {
    ...
    getClient(): Promise<import("bullmq").IRedisClient>;
